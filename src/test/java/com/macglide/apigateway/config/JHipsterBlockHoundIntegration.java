package com.macglide.apigateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.macglide.apigateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.macglide.apigateway.security.DomainUserDetailsService", "createSpringSecurityUser");
